...
public class viewAdminCategory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HttpSession httpsession = (HttpSession) request.getSession();
			...
			String seller_information=request.getParameter("viewAdminCategory");
			try
			{
				...
				om.setJMSCorrelationID("viewAdminCategory");
				...
				if(mailId!=null && pwd!=null)
				{
					...
					out.println(reply.getStringProperty("viewAdminCategory"));
					String result=reply.getStringProperty("viewAdminCategory");
					
					if(result.equalsIgnoreCase("true")){
						
						HttpSession session=request.getSession();
						session.setAttribute("UserSession", session);
						String destination = "/SuccessLoginAdmin.jsp";
