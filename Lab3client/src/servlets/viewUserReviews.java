...
public class viewUserReviews extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		;
				om.setJMSCorrelationID("viewUserReviews");
				...
				if(emailid!=null)
				{
					...
					out.println(reply.getStringProperty("viewUserReviews"));
					String result=reply.getStringProperty("viewUserReviews");
					...
					if(result.equalsIgnoreCase("true")){
						...
						String destination = "/AccountsSuccess.jsp";
